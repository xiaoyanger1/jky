...
namespace SysDetection.Detection
{
    public partial class DetectionSet : Form
    {
        ...
        private void SelectDangHao(object sender, SysDetection.Detection.Select_Code.TransmitEventArgs e)
        {
            CurrCode = e.Code;
            CurrDangH = e.DangHao;
            Init();
        ...
        private Model_dt_Settings GetSettings()
        {
            ...
            model.dt_Create = DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss");
