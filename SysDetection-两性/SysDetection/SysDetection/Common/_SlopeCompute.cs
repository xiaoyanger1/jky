...
namespace Jky.Public.Common
{
    public class _SlopeCompute
    {
        ...
        private static List<Dict> 温度传感器Dict
        {
            ...
            {
                if (_温度传感器Dict == null)
                    温度传感器Dict = DemarcateList.FindAll(t => t.Enum == SysDetection.Common._Public_Enum.ENUM_Demarcate.enum_温度传感器.ToString()).OrderBy(t => t.x).ToList();
                return _温度传感器Dict;
            }
            set
            {
        ...
        private static List<Dict> 差压传感器Dict
        {
            ...
            {
                if (_差压传感器Dict == null)
                    差压传感器Dict = DemarcateList.FindAll(t => t.Enum == SysDetection.Common._Public_Enum.ENUM_Demarcate.enum_差压传感器.ToString()).OrderBy(t => t.x).ToList();
                return _差压传感器Dict;
            }
            set
            {
        ...
        private static List<Dict> 风速传感器Dict
        {
            ...
            {
                if (_风速传感器Dict == null)
                    风速传感器Dict = DemarcateList.FindAll(t => t.Enum == SysDetection.Common._Public_Enum.ENUM_Demarcate.enum_风速传感器.ToString()).OrderBy(t => t.x).ToList();
                return _风速传感器Dict;
            }
            set
            {
        ...
        private static List<Dict> 大气压力传感器Dict
        {
            get
            {
                if (_大气压力传感器Dict == null)
                    大气压力传感器Dict = DemarcateList.FindAll(t => t.Enum == SysDetection.Common._Public_Enum.ENUM_Demarcate.enum_大气压力传感器.ToString()).OrderBy(t => t.x).ToList();
                return _大气压力传感器Dict;
            }
            set
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static double GetValues(SysDetection.Common._Public_Enum.ENUM_Demarcate enum_Demarcate, float x)
        {
            //if (x < 0)
            //{
            //    x = 0;
        ...
        /// <returns></returns>
        private static List<Dict> GetListByEnum(SysDetection.Common._Public_Enum.ENUM_Demarcate enum_Demarcate)
        {
            if (enum_Demarcate == SysDetection.Common._Public_Enum.ENUM_Demarcate.enum_差压传感器)
            {
                return 差压传感器Dict;
            }
            if (enum_Demarcate == SysDetection.Common._Public_Enum.ENUM_Demarcate.enum_大气压力传感器)
            {
                return 大气压力传感器Dict;
            }
            if (enum_Demarcate == SysDetection.Common._Public_Enum.ENUM_Demarcate.enum_风速传感器)
            {
                return 风速传感器Dict;
            }
            if (enum_Demarcate == SysDetection.Common._Public_Enum.ENUM_Demarcate.enum_温度传感器)
            {
                return 温度传感器Dict;
            }
