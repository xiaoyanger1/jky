...
namespace SysDetection.model
{
    public class Pressure
    {
        ...
        public void AddZYFJ(double data, SysDetection.Common._Public_Enum.ENUM_FS fs)
        {
            if (fs == SysDetection.Common._Public_Enum.ENUM_FS.YL_S100)
                ZYFJ_100.Add(data);
            if (fs == SysDetection.Common._Public_Enum.ENUM_FS.YL_S150)
                ZYFJ150.Add(data);
            if (fs == SysDetection.Common._Public_Enum.ENUM_FS.YL_J100)
                ZYFJ100.Add(data);
        }
        ...
        /// <param name="data"></param>
        /// <param name="fs">风速枚举</param>
        public void AddZYZD(double data, SysDetection.Common._Public_Enum.ENUM_FS fs)
        {
            if (fs == SysDetection.Common._Public_Enum.ENUM_FS.YL_S100)
                ZYZD_100.Add(data);
            if (fs == SysDetection.Common._Public_Enum.ENUM_FS.YL_S150)
        ...
        /// <param name="data"></param>
        /// <param name="fs">风速枚举</param>
        public void AddFYFJ(double data, SysDetection.Common._Public_Enum.ENUM_FS fs)
        {
            if (fs == SysDetection.Common._Public_Enum.ENUM_FS.YL_S100)
                FYFJ_100.Add(data);
            if (fs == SysDetection.Common._Public_Enum.ENUM_FS.YL_S150)
        ...
        /// <param name="data"></param>
        /// <param name="fs">风速枚举</param>
        public void AddFYZD(double data, SysDetection.Common._Public_Enum.ENUM_FS fs)
        {
            if (fs == SysDetection.Common._Public_Enum.ENUM_FS.YL_S100)
                FYZD_100.Add(data);
            if (fs == SysDetection.Common._Public_Enum.ENUM_FS.YL_S150)
