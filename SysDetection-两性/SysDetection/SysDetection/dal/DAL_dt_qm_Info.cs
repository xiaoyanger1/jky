...
namespace SysDetection.dal
{
 ...
 where dt_Code = '{4}' and info_DangH='{5}'
        ...
        /// <returns></returns>
        public DataTable GetInfoByCode(string code, SysDetection.Common._Public_Enum.ENUM_DetectionItem? enum_DetectionItem)
        {
            string sql = "";
        ...
        public void AddSM_QM(List<Model_dt_qm_Info> qmModel, List<Model_dt_sm_Info> smModel, SysDetection.Common._Public_Enum.ENUM_DetectionItem? enum_DetectionItem)
        {
