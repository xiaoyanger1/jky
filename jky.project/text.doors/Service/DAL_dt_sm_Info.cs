...
namespace text.doors.Service
{
    public class DAL_dt_sm_Info
    {
        ...
        public bool Add(Model_dt_sm_Info model)
        {
            ...
            var sql = string.Format("insert into dt_sm_Info (dt_Code,info_DangH,sm_PaDesc,sm_Pa,sm_Remark) values('{0}','{1}','{2}','{3}','{4}')", model.dt_Code, model.info_DangH, model.sm_PaDesc, model.sm_Pa, model.sm_Remark);
